# Generated by Django 2.2.13 on 2020-11-24 21:10
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('adserver', '0044_update_defaults_and_remove_deprecated_field'),
    ]

    operations = [
        migrations.CreateModel(
            name='UpliftImpression',
            fields=[
                ...
                ('advertisement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='uplift_impressions', to='adserver.Advertisement')),
                ('publisher', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='uplift_impressions', to='adserver.Publisher')),
            ],
            options={
                'ordering': ('-date',),
