# Generated by Django 2.2.13 on 2020-11-16 23:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('adserver', '0041_add_decision_indexes'),
    ]

    operations = [
        migrations.CreateModel(
            name='KeywordImpression',
            fields=[
                ...
                ('keyword', models.CharField(max_length=1000, verbose_name='Keyword')),
                ('advertisement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='keyword_impressions', to='adserver.Advertisement')),
                ('publisher', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='keyword_impressions', to='adserver.Publisher')),
            ],
            options={
                'ordering': ('-date',),
