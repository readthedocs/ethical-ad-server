# Generated by Django 3.2.18 on 2023-02-21 19:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('adserver', '0076_add_pacing_interval'),
    ]

    operations = [
        migrations.CreateModel(
            name='PublisherPaidImpression',
            fields=[
                ...
                ('publisher', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='publisher_paid_impressions', to='adserver.publisher')),
            ],
            options={
                'verbose_name_plural': 'Publisher paid impressions',
                'ordering': ('-date',),
