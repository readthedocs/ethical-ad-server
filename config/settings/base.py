...
# Local path to store offers parquet files for local development and testing.
# This is used by the audience estimator and nightly aggregations
# for faster reporting. In production, parquet files are stored in S3 and this is ignored.
ADSERVER_OFFERS_LOCAL_PATH = env("ADSERVER_OFFERS_LOCAL_PATH", default=MEDIA_ROOT)
...
ADSERVER_ANALYZER_EMBEDDING_MODEL = env(
    "ADSERVER_ANALYZER_EMBEDDING_MODEL",
    default=None,
)
